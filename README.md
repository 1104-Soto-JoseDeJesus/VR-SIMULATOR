...
Within the graphical interface a dedicated **Battlefield** tab renders the
grid and provides simple controls to issue movement orders. Use the "Reset from
Setup" button to load the armies defined in the **Army Setup** tab and step the
simulation round by round.
