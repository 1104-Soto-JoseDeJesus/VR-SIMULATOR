...
adjacent cells while the duel resolves. Armies can be added via an **Add Army** button with up to
five per team, letting larger forces clash. When two armies are ordered to the same hex they will
march until they stand on neighbouring tiles before fighting. A companion **Battlefield Reports**
tab lists the battle log for each army. A **Reset from Setup** button reloads a fresh copy of the
