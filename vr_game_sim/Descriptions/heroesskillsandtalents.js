...
const HeroesSkillsAndTalents = [
    ...
    {
        name: "Margit",
        skillonename: "Ride the Waves",
        skillonetype: "Cooperation",
        skilloneprob: 100,
        skillonedescr: "Permanently increases this hero's army basic attack damage by 20% (cannot be dispelled). Additionally, if the target is affected by Slow, basic attacks have a 50% chance to grant an extra 100% basic attack damage bonus for 2 rounds (applies starting next round) that can be dispelled.",
        skilltwoname: "Raging Tide",
        skilltwotype: "Active",
        skilltwoprob: 100,
        skilltwodescr: "Requires 1,000 Rage. Deals direct damage 1 time (Damage Factor 1,600) to the target, inflicts Bleed (Damage Factor 600) for 2 rounds (starting next round), and applies Slow for 4 rounds (starting next round).",
        skillawakename: "—",
        skillawaketype: "—",
        skillawakeprob: 0,
        skillawakedescr: "",
        ...
        talentwotype: "Cooperation",
        talenttwodescr: "When deployed Troops perform a basic attack, if the target is Bleeding, there is a 35% chance to heal Lightly Wounded units in this army 1 time (Heal Factor 800).",
        talentthreename: "Seas Grace",
        talentthreetype: "Command",
        talentthreedescr: "Every 6 rounds, purifies 1 random debuff from this hero's army (effect applies next round) and randomly inflicts either Bleed (Damage Factor 1000 for 2 rounds, starting next round) or Slow for 2 rounds (starting next round) on the target.",
        id: 10
    },
    {
        name: "Cecia",
    ...
    {
        name: "Leandra",
        skillonename: "Vengeful Fury",
        skillonetype: "Cooperation",
        skilloneprob: 20,
        skillonedescr: "When this hero's army performs a basic attack, there is a 20% chance to inflict Burning on the target, dealing continuous damage every second (Damage Factor 200) for 2 rounds (applies starting next round). If this effect triggers and the target is already Poisoned, this hero's army gains 100 Rage next round.",
        skilltwoname: "Serrated Flourish",
        skilltwotype: "Active",
        skilltwoprob: 100,
        skilltwodescr: "Requires 1,000 Rage. Deals 1 instance of direct damage (Damage Factor 1,400) to the target, with a 50% chance to immediately deal another instance of damage (Damage Factor 1,400). The initial strike has a 50% chance to inflict Poison, dealing continuous damage every second (Damage Factor 600) for 3 rounds (starting next round).",
        skillawakename: "—",
        skillawaketype: "—",
        skillawakeprob: 0,
        skillawakedescr: "",
        ...
        talentwotype: "Cooperation",
        talenttwodescr: "If the target is Burning, basic attacks have a 25% chance to deal damage 1 time (Damage Factor 500). If the target is not Burning, basic attacks instead have a 25% chance to heal your own army 1 time (Heal Factor 500).",
        talentthreename: "Opportune Strike",
        talentthreetype: "Command",
        talentthreedescr: "Every 6 rounds, inflict Poison on the target, dealing continuous damage every second (Damage Factor 650) for 2 rounds (starting next round).",
        id: 24
    },
    {
        name: "Sasha",
