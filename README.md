...
hex per second and battles also play out in real time – a 30‑round duel occupies the armies for
30 seconds before the result is applied. Double‑click a marker to open a dedicated configuration
