...
const HeroesSkillsAndTalents = [
    ...
    },
    {
        ...
        skillonetype: "Active",
        skilloneprob: 100,
        skillonedescr: "Deals 1 instance of single-target damage (Damage Factor 1,050) to the target and inflicts them with Bleed. Bleeding enemies take continuous damage (Damage Factor 400) for 2 rounds (after trigger round).",
        skilltwoname: "Ride the Waves",
        skilltwotype: "Cooperation",
        skilltwoprob: 100,
        skilltwodescr: "Increases deployed Troops Basic Attack Damage by 20 %. When performing a basic attack, if the target is Slowed, there is a 50 % chance for your own Troop to increase their Basic Attack Damage by 100% for 2 rounds (after trigger round).",
        skillawakename: "Raging Tide",
        skillawaketype: "Active",
        skillawakeprob: 100,
        skillawakedescr: "Deals 1 instance of single-target damage (Damage Factor 1,600) to the target and inflicts them with Bleed. Bleeding enemies take continuous damage (Damage Factor 600) for 2 rounds (after trigger round). Also inflicts target with Slow, reducing their March Speed by 25 % for 4 rounds (after trigger round).",
        ...
        talentthreetype: "Command",
        talentthreedescr: "Every 6 rounds (after trigger round), purifies own Troop of 1 Debuff, and randomly inflicts one of the following effects on the target: Bleed, which causes continuous damage (Damage Factor 1000) for 2 rounds (after trigger round), or Slow, which reduces March Speed by 30% for 2 rounds (after trigger round).",
        id: 10
    },
    {
        name: "Cecia",
    ...
    },
    {
        ...
        skillonetype: "Active",
        skilloneprob: 100,
        skillonedescr: "Deals 1 instance of direct damage (Damage Factor 900) to the target with a 50 % chance of dealing another instance of damage (Damage Factor 900). Also has a 50 % chance to Poison the target when dealing damage for the first time. Poisoned enemies take continuous damage (Damage Factor 360) for 3 rounds (after trigger round).",
        skilltwoname: "Vengeful Fury",
        skilltwotype: "Cooperation",
        skilltwoprob: 20,
        skilltwodescr: "When deployed Troop performs a basic attack, there is a 20 % chance to inflict Burning on the target, dealing continuous damage (Damage Factor 200) for 2 rounds (after trigger round). If the target is already Poisoned, deployed Troop gains an additional 100 Rage.",
        skillawakename: "Serrated Flourish",
        skillawaketype: "Active",
        skillawakeprob: 100,
        skillawakedescr: "Deals 1 instance of direct damage (Damage Factor 1,400) to the target with a 50 % chance of dealing another instance of damage (Damage Factor 1,400). Also has a 50 % chance to Poison the target when dealing damage for the first time. Poisoned enemies take continuous damage (Damage Factor 600) for 3 rounds (after trigger round).",
        ...
        talentwotype: "Cooperation",
        talenttwodescr: "If the target is Burning, basic attacks have a 25% chance to deal damage 1 time (Damage Factor 500). If the target is not burning, your Troop has a 25% chance to heal 1 time (Heal Factor 500).",
        talentthreename: "Opportune Strike",
        talentthreetype: "Command",
        talentthreedescr: "Every 6 rounds (after trigger round), inflict Poison on the target, dealing continuous damage (Damage Factor 650) for 2 rounds (after trigger round).",
        id: 24
    },
    {
        name: "Sasha",
