...
class BattlefieldTab(QtWidgets.QWidget):
    ...
    def _add_army(self) -> None:
        ...
        # Ensure the simulator sees the new army.  ``MultiArmySimulator`` keeps a
        # reference to the same list object, but if the list was replaced during
        # simulation, explicitly append to its copy as well.
